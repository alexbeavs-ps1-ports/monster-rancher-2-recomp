...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Monster Rancher 2",
    .project_root_env = "MONSTER_RANCHER_2_RECOMP_PROJECT_ROOT",
    .build_dir_env = "MONSTER_RANCHER_2_RECOMP_BUILD_DIR",
    .force_setup_env = "MONSTER_RANCHER_2_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_009.17_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Monster_Rancher_2__Recompiled",
    .prepare_note =
